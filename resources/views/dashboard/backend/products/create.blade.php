        ...
        <form action="{{ route('admin.products.store') }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="name_ar" value="{{ old('name_ar') }}" class="form-control form-control-solid" placeholder="Enter name" >
            ...
            <div class="row">
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="desc_en" value="{{ old('desc_en') }}" class="form-control form-control-solid" placeholder="Enter description" >
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="desc_ar" value="{{ old('desc_ar') }}" class="form-control form-control-solid" placeholder="Enter description" >
                    @error('desc') <span class="text-danger">{{ $message }}</span>  @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="qty" value="{{ old('qty') }}" class="form-control form-control-solid" placeholder="Enter Quantity" >
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="time" value="{{ old('time') }}" class="form-control form-control-solid" placeholder="Enter Time" >
            ...
            <div class="row">
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="price" value="{{ old('price') }}" class="form-control form-control-solid" placeholder="Enter Price" >
